...
export default function App() {
        ...
        let ctx = gsap.context(() => {
            ScrollTrigger.matchMedia({
                "(min-width: 768px)": function() {
                    ...
                    heroTl.to(".hero-text-panel", { xPercent: -100, opacity: 0 })
                    ...
                    solutionsTl.fromTo(".solution-background", { scale: 1 }, { scale: 1.2 })
    ...
    return (
        <>
            ...
            <MenuOverlay isOpen={isMenuOpen} onClose={handleMenuToggle} onNavigate={handleNavigate} />
